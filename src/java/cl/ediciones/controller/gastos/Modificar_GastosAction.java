...
public class Modificar_GastosAction extends Action {
    ...
    public ActionForward execute(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response) throws Exception {
        ...
        gastos.setId_gastos(Integer.parseInt(id_gastos));
        ...
        gasDAO.update(gastos);

        return mapping.findForward("ModificarGastos");
    }
}
