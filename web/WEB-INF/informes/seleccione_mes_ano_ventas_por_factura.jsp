...
<html>
    ...
    <body>
        <form name="formData" method="post" action="<%=request.getContextPath()%>/controller/VentaPorFactura.ed">
            <table width="100%">
                <tr>
                    <th class="menuSuperior">Seleccione Mes y Año para Ventas por Factura</th>
                </tr>
            </table>
            <br>
            <table align="center">
