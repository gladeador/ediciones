...
<html>
    <head>
        ...
        <title>.:: Seleccione Año Ranking Acumulado ::.</title>
    ...
    <body>
        <form name="formData" method="post" action="<%=request.getContextPath()%>/controller/RankingAcumuladoClientes.ed">
            <table width="100%">
                <tr>
                    <th class="menuSuperior">Seleccione Año Ranking Acumulado</th>
                </tr>
            </table>
            <br>
            <table align="center">
