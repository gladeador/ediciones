...
<html>
    <head>
        ...
        <title>.:: Seleccione Periodo Balance ::.</title>
    ...
    <body>
        <form name="formData" method="post" action="<%=request.getContextPath()%>/controller/InformeBalance.ed">
            <table width="100%">
                <tr>
                    <th class="menuSuperior">Seleccione Periodo Balance</th>
                </tr>
            </table>
            <br>
            <table align="center">
