...
<html>
    <head>
        ...
        <title>.:: Informe Flujo Cierre de Mes Real ::.</title>
    ...
    <body>
        <form name="formData">
            <table width="100%">
                <tr>
                    <th class="menuSuperior">Informe Flujo Cierre de Mes Real</th>
                </tr>
            </table>
            <br>
            <fieldset>
                        ...
                        <%
                            ...
                            for (int i = factura.getMes_factura(); i <= (cont + 2); i++) {
                                ...
                                if (forma.getId_forma_pago() == 2) {
                                    ...
                                    ArrayList lista_cheques = cheDAO.traerTodos_Cheque_por_Factura_Pagado(factura.getId_factura());
                                ...
                                if (forma.getId_forma_pago() == 3) {
                                    ...
                                    ArrayList lista_cuotas = cuoDAO.traerTodos_Cuota_por_Factura_Pagado(factura.getId_factura());
                                ...
                                if (forma.getId_forma_pago() == 4) {
                                    ...
                                    ArrayList lista_letras = letDAO.traerTodos_Letra_por_Factura_Pagado(factura.getId_factura());
