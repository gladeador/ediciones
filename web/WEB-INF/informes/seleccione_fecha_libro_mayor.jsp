...
<html>
    <head>
        ...
        <title>.:: Seleccione Periodo Libro Mayor ::.</title>
    ...
    <body>
        <form name="formData" method="post" action="<%=request.getContextPath()%>/controller/InformeLibroMayor.ed">
            <table width="100%">
                <tr>
                    <th class="menuSuperior">Seleccione Periodo Libro Mayor</th>
                </tr>
            </table>
            <br>
            <table align="center">
