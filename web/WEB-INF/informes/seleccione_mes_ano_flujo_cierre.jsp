...
<html>
    <head>
        ...
        <title>.:: Seleccione Mes y Año Informe Flujo Cierre Mes ::.</title>
    ...
    <body>
        <form name="formData" method="post" action="<%=request.getContextPath()%>/controller/InformeFlujoCierre.ed">
            <table width="100%">
                <tr>
                    <th class="menuSuperior">Seleccione Mes y Año Informe Flujo Cierre Mes</th>
                </tr>
            </table>
            <br>
            <table align="center">
