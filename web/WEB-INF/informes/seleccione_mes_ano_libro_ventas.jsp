...
<html>
    <head>
        ...
        <title>.:: Seleccione Mes y Año Informe Libro Ventas ::.</title>
    ...
    <body>
        <form name="formData" method="post" action="<%=request.getContextPath()%>/controller/InformeLibroVentas.ed">
            <table width="100%">
                <tr>
                    <th class="menuSuperior">Seleccione Mes y Año Informe Libro Ventas</th>
                </tr>
            </table>
            <br>
            <table align="center">
