...
<html>
    <head>
        ...
        <title>.:: Seleccione Mes y Año Informe Cobranza::.</title>
    ...
    <body>
        <form name="formData" method="post" action="<%=request.getContextPath()%>/controller/InformeCobranza.ed">
            <table width="100%">
                <tr>
                    <th class="menuSuperior">Seleccione Mes y Año Informe Cobranza</th>
                </tr>
            </table>
            <br>
            <table align="center">
