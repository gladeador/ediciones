...
<html>
    ...
    %>
    <body>
        <form name="formData" method="post" action="<%=request.getContextPath()%>/controller/AgregarGastos.ed">
            <table width="100%">
                <tr>
                    <th class="menuSuperior">Agregar Gastos</th>
                </tr>
            </table>
            <br>
            <fieldset>
                ...
                <table width="100%">
                    <tr>
                        ...
                        <td><input name="num_boleta" type="text" class="cuadroTexto" id="num_boleta" value="0"></td>
