...
<html>
    ...
    <body>
        <form name="formData" action="<%=request.getContextPath()%>/controller/AgregarProductos.ed">
            <table width="100%">
                <tr>
                    <th class="menuSuperior">Agregar Productos</th>
                </tr>
            </table>
            <br>
            <table align="center">
                        ...
                        <fieldset>
                            ...
                            <table>
                                <tr>
                                    ...
                                    <td><input name="descripcion" type="text" class="cuadroTexto" id="descripcion" size="30" onchange="javascript:this.value = this.value.toUpperCase();"></td>
                                </tr>
                                <tr>
