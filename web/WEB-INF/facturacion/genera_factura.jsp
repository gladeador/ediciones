...
<html>
    <head>
        ...
        <script>
            function valida_Num_Factura(num_factura){
                Factura.validar_Num_Factura(num_factura, recuperaValida);
            }
            ...
            function recuperaValida(data){
                if(data == null){
                    ...
                    alert("El Nº de Factura  ingresado, ya se encuentra en nuestros Registros.");
            ...
            function guardar(){
                ...
                if (!confirm("¿Esta seguro que desea crear una Factura Nº"+num_factura+"?")){
                    return;
                }
                Factura.guardar_Factura(num_factura, fecha_factura, recuperaFactura);
            }
            
            function recuperaFactura(id_factura){
            ...
            function busca_Clientes(nombre){
                Clientes.listar_Clientes_por_Nombre(nombre, cargarClientes);
            }
            ...
            function cargaStockBodega(data) {
                ...
                var cantidad = document.getElementById("cantidad").value;
                if (cantidad > data) {
                    alert("La cantidad que esta ingresando es mayor la del Stock de Bodega, el Stock en Bodega es de "+data);
                    return;
                };
            ...
            function cargaFacturaProductos(data){
                ...
                var cellFuncs = [
                    ...
                    function(data) { return "<a href=\"javascript:Confirmar("+data.factura.id_factura+","+data.productos.id_productos+");\"><img src=\"<%=request.getContextPath()%>/images/iconos/eliminar.png\" border=\"0\" width=\"20\" height=\"20\" title=\"Eliminar\"></a>"}
                ]
                id=-1;
            ...
            function cargarSelec_Guias(data){
                ...
                var cellFuncs = [
                    ...
                    function(data) { return data.clientes.rut+" "+data.clientes.dv; },
                    function(data) { return data.clientes.nombre; },
                    function(data) { return data.total; },
                    function(data) { return "<a href=\"javascript:cargar_Guia("+data.id_guia_despacho+");\"><img src=\"<%=request.getContextPath()%>/images/iconos/seleccionar.png\" border=\"0\" width=\"20\" height=\"20\" title=\"Seleccionar\"></a>"}
                ]
                id=-1;
    ...
    <body>
        <form name="formData" method="post" action="<%=request.getContextPath()%>/controller/EmitirFactura.ed">
            <table width="100%">
                <tr>
                    <th class="menuSuperior">FACTURA</th>
                </tr>
            </table>
            <br>
            <table width="100%">
                <tr>
                    <td>
                        <table align="center">
                            <tr>
                                <th class="specalt">N&deg; Factura</th>
                                <td><input name="num_factura" type="text" class="cuadroTexto" id="num_factura"><input name="id_factura" type="hidden" id="id_factura"></td>
                                <td><div style="border:#000066;" id="agregar"><a href="javascript:valida_Num_Factura(num_factura.value);" target="_self" type="button"><img src="<%=request.getContextPath()%>/images/iconos/guardar.png" border="0" width="30" height="30" title="Guardar"></a></div></td>
                            </tr>
                        </table>
                        <div style="display:none; border:#000066;" id="clientes" >
                            <fieldset>
                                ...
                                <table>
                                    <tr>
                                        <th class="specalt" valign="top">Fecha Factura </th>
                                        <td valign="middle">
                                            <input name="fecha_factura" type="text" class="cuadroTexto" id="fecha_factura" align="left" value="<%=fecha.getFecha_actualStr()%>" onChange="javascript:modifica_fecha_Factura();" readonly>
        ...
        <div id="ver_clientes" style="display:none; background:#123" >
            <fieldset>
                <table>
                    <tr>
                        <th class="specalt">Nombre </th>
                        <td><input name="nombre_busca" type="text" id="nombre_busca" class="cuadroTexto" onkeyup="javascript:busca_Clientes(this.value.toUpperCase()); this.value = this.value.toUpperCase();" /></td>
                    </tr>
                </table>
                <table align="center" width="100%">
                    <tr>
