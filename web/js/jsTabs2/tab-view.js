...
var tabView_maxNumberOfTabs = 40;	// Maximum number of tabs
...
function showTab(parentId,tabIndex) {
    ...
    if(activeTabIndex[parentId]>=0){
        ...
        img.src = contexto+'/images/tabs/tab_right_inactive.gif';
    ...
    img.src = contexto+'/images/tabs/tab_right_active.gif';
...
function rolloverTab() {
    if(this.className.indexOf('tabInactive')>=0){
        ...
        img.src = contexto+'/images/tabs/tab_right_over.gif';
    }
...
function initTabs(mainContainerID,tabTitles,activeTab,width,height,closeButtonArray,additionalTab) {
    ...
    for(var no=0;no<tabTitles.length;no++){
        ...
        if(closeButtonArray[no]){
            ...
            closeButton.src = contexto+'/images/tabs/close.gif';
...
function createNewTabAuto(parentId,tabTitle,tabContent,tabContentUrl,closeButton,i) { //Esta funcion, me permite crear TAB automaticos
...
function createNewTab(parentId,tabTitle,tabContent,tabContentUrl,closeButton) { //Esta funcion, me permite crear TAB de a uno
    if(tabView_countTabs[parentId]>=tabView_maxNumberOfTabs)return;	// Maximum number of tabs reached - return
    var div = document.createElement('DIV');
    div.className = 'dhtmlgoodies_aTab';
    dhtmlgoodies_tabObj[parentId].appendChild(div);		
